...
def own_main():
    ...
    file_classifier_name = "8500_classifier.p"
    file_classifier = file_pickle_directory + file_classifier_name
    classifer_object = "classifier"
    file_scaler_name = "8500_scaler.p"
    file_scaler = file_pickle_directory + file_scaler_name
